    ...
    <nav id="top-menu" role="navigation" style="opacity: 0;">
      <div class="menu-svg">
        <svg width="377px" height="2045px" viewBox="0 0 377 2045" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="about-side" class="svg-link horizontal-link " data-gradient="about-side-gradient" data-href="http://jejulaf.com/about" transform="translate(4.000000, 303.000000)">
                ...
                <g id="visit-side" class="svg-link radial-link " data-gradient="visit-side-gradient" data-href="http://jejulaf.com/visit" transform="translate(3.000000, 301.000000)">
                ...
                <g id="press-side" class="svg-link radial-link " data-gradient="press-side-gradient" data-href="http://jejulaf.com/press" transform="translate(3.000000, 1744.000000)">
                ...
                <g id="calendar-side" class="svg-link vertical-link " data-gradient="calendar-side-gradient" data-href="http://jejulaf.com/calendar" transform="translate(1.000000, 1637.000000)">
                    <g id="Rectangle">
            ...
            <!-- about -->
            <linearGradient id="about-side-gradient" x1="96.8865741%" y1="62.4869466%" x2="0%" y2="62.4869466%">
                <stop stop-color="#FF96D5" offset="0%"></stop>
                <stop stop-color="#FF96D5" offset="29.77%"></stop>
                <stop stop-color="#FF97CE" offset="40.58%"></stop>
                <stop stop-color="#FF98B9" offset="57.0452009%"></stop>
            ...
            <!-- visit -->
            <radialGradient id="visit-side-gradient" cx="50%" cy="50%" fx="50%" fy="50%" r="60.43211%" gradientTransform="translate(0.500000,0.500000),scale(0.888827,1.000000),rotate(90.000000),translate(-0.500000,-0.500000)">
                <stop stop-color="#00FFF7" offset="0%"></stop>
                <stop stop-color="#00FFF7" offset="31.7283163%"></stop>
                <stop stop-color="#09FFA3" offset="81.6984216%"></stop>
                <stop stop-color="#12FF4C" offset="100%"></stop>
            ...
            <!-- press gradient -->
            <radialGradient id="press-side-gradient" cx="50.8327901%" cy="50%" fx="50.8327901%" fy="50%" r="50%" gradientTransform="translate(0.508328,0.500000),scale(0.665417,1.000000),rotate(90.000000),scale(1.000000,1.511267),translate(-0.508328,-0.500000)">
                <stop stop-color="#EF0007" offset="0%"></stop>
                <stop stop-color="#EF0007" offset="10.9534439%"></stop>
                <stop stop-color="#7A0038" offset="60.3176818%"></stop>
                <stop stop-color="#5A0029" offset="73.698581%"></stop>
