<template>
  <div class="app">
      ...
      <svg width="1443px" height="1264px" viewBox="0 0 1443 1264" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <g id="calendar-main" class="svg-link vertical-link" @click="navigateTo('calendar')" data-gradient="calendar-gradient" transform="translate(547.000000, 669.000000)" @mouseover="gradient('calendar-gradient', 'y')" @mouseout="stopGradient">
            ...
            <text id="Calendar" fill="#FFFFFF" font-family="Arial" font-size="40" font-weight="normal">
          ...
          <g id="press-main" class="svg-link radial-link" data-gradient="press-gradient" @click="navigateTo('press')" transform="translate(722.000000, 783.000000)" @mouseover="gradient('press-gradient', 'r')" @mouseout="stopGradient">
            ...
            <text id="Press" fill="#FFFFFF" font-family="Arial" font-size="40" font-weight="normal">
          ...
          <g id="limo-main" class="svg-link radial-link" @click="navigateTo('limolimo')" data-gradient="limo-gradient" transform="translate(6.000000, 1024.000000)" @mouseover="gradient('limo-gradient', 'r')" @mouseout="stopGradient">
          ...
          <g id="channel-main" transform="translate(547.000000, 2.000000)" @click="navigateTo('channel')">
            ...
            <text id="Channel" font-family="Arial" font-size="40" font-weight="normal" fill="#FEFEFE">
        ...
        <!-- about -->
        <linearGradient id="about-gradient" x1="96.8865741%" y1="62.4869466%" x2="0%" y2="62.4869466%">
        ...
        <!-- visit -->
        <radialGradient id="visit-gradient" cx="50%" cy="50%" fx="50%" fy="50%" r="60.43211%" gradientTransform="translate(0.500000,0.500000),scale(0.888827,1.000000),rotate(90.000000),translate(-0.500000,-0.500000)">
        ...
        <!-- press gradient -->
        <radialGradient id="press-gradient" cx="50.8327901%" cy="50%" fx="50.8327901%" fy="50%" r="50%" gradientTransform="translate(0.508328,0.500000),scale(0.665417,1.000000),rotate(90.000000),scale(1.000000,1.511267),translate(-0.508328,-0.500000)">
    ...
    <nav id="top-menu" role="navigation" style="display: block;">
      <div class="menu-svg">
        <svg width="377px" height="2045px" viewBox="0 0 377 2045" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="about-side" class="svg-link horizontal-link " @click="navigateTo('about')" data-gradient="about-side-gradient" transform="translate(4.000000, 303.000000)">
            ...
            <g id="visit-side" class="svg-link radial-link " @click="navigateTo('visit')" data-gradient="visit-side-gradient" transform="translate(3.000000, 301.000000)">
            ...
            <g id="press-side" class="svg-link radial-link " data-gradient="press-side-gradient" @click="navigateTo('press')" transform="translate(3.000000, 1744.000000)">
            ...
            <g id="limo-side" class="svg-link radial-link " data-gradient="limo-side-gradient" @click="navigateTo('limolimo')" transform="translate(155.000000, 939.000000)">
            ...
            <g id="artists-side" class="svg-link vertical-link " data-gradient="artists-side-gradient" @click="navigateTo('artists')" transform="translate(3.000000, 2.000000)">
            ...
            <g id="news-side" class="svg-link horizontal-link " data-gradient="news-side-gradient" @click="navigateTo('news')" transform="translate(124.000000, 1312.000000)">
            ...
            <g id="tickets-side" class="svg-link horizontal-link " data-gradient="tickets-side-gradient" @click="navigateTo('tickets')" transform="translate(3.000000, 1746.000000)">
