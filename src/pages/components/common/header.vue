  ...
  <header>
    <div class="inner">
      ...
      <div class="mobile-header ">
        <button><!-- <span class="title">home</span> --></button>
      </div>
      <nav id="RightNav" role="navigation">
        ...
        <ul class="social">
          <li><a href="https://www.facebook.com/jejulaf.2018/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
          <li><a href="https://www.instagram.com/jejulaf/" target="_blank"><i class="fab fa-instagram"></i></a></li>
          <li>
            <a href="https://blog.naver.com/jejulaf" target="_blank">
